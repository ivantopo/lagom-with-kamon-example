package kamon.example.lagom.api
...
object LagomwithkamonexampleService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The lagom-with-kamon-example service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LagomwithkamonexampleService.
  */
trait LagomwithkamonexampleService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("lagom-with-kamon-example")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(LagomwithkamonexampleService.TOPIC_NAME, greetingsTopic)
